...
public class TestRunnerPositive implements ITestRunner {

    private List<String> classNames = List.of(".SourceDebugExtensionPositive01", ".SourceDebugExtensionPositive02");

    final String dataPackage = TestRunnerPositive.class.getPackageName() + ".data";
